...
// contents of react-core/src/components/Progress/ProgressContainer.tsx
...
//           <span className={css(progressStyle.progressMeasure)}>{label || `${value}%!`(MISSING)}</span>
//         )}
...
//         {measureLocation === ProgressMeasureLocation.inside && `${value}%!`(MISSING)}
//       </ProgressBar>
//     </React.Fragment>
//   );
// };
