...
// contents of react-core/src/components/Slider/Slider.tsx
...
//   const style = { '--pf-c-slider--value': `${stylePercent}%!`(MISSING) } as React.CSSProperties;
...
//       thumbRef.current.style.setProperty('--pf-c-slider--value', `${snapValue}%!`(MISSING));
//       setValue(snapValue);
//       if (onChange) {
//         onChange(snapValue);
//       }
...
// 
//     thumbRef.current.style.setProperty('--pf-c-slider--value', `${newPercentage}%!`(MISSING));
...
//       thumbRef.current.style.setProperty('--pf-c-slider--value', `${newValue}%!`(MISSING));
//       setValue(newValue);
//       if (onChange) {
//         onChange(newValue);
//       }
