											...
											app.Button().
												...
												Body(
													app.Div().
														...
														Body(
															app.Text("First notification group"),
														),
													app.Div().
											...
											app.Button().
												...
												Body(
													app.Div().
														Class("pf-c-notification-drawer__group-toggle-title").
														Body(
															app.Text("Second notification group"),
														),
													app.Div().
														Class("pf-c-notification-drawer__group-toggle-count").
														Body(
											...
											app.Button().
												...
												Body(
													app.Div().
														Class("pf-c-notification-drawer__group-toggle-title").
														Body(
															app.Text("Third notification group"),
														),
													app.Div().
														Class("pf-c-notification-drawer__group-toggle-count").
														Body(
											...
											app.Button().
												...
												Body(
													app.Div().
														Class("pf-c-notification-drawer__group-toggle-title").
														Body(
															app.Text("Fourth notification group"),
														),
													app.Div().
														Class("pf-c-notification-drawer__group-toggle-count").
														Body(
