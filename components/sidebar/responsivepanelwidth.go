...
type ResponsivePanelWidth struct {
	app.Compo
}

func (c *ResponsivePanelWidth) Render() app.UI {
	return app.Div().
		Class("pf-c-sidebar").
		Body(
			app.Div().
						...
						Body(
							app.Div().
								...
								Body(
									app.P().
										Body(
											app.Text("Changes the panel with and can change responsively at different breakpoints."),
										),
									app.P().
										Body(
