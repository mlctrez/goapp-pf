...
type SelectedFiltersOnMobileFiltersCollapsedSelectedFiltersSummaryVisible struct {
	app.Compo
}

func (c *SelectedFiltersOnMobileFiltersCollapsedSelectedFiltersSummaryVisible) Render() app.UI {
	return app.Div().
		Class("pf-c-toolbar").
