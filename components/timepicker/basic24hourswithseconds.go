...
type Basic24HoursWithSeconds struct {
	app.Compo
}

func (c *Basic24HoursWithSeconds) Render() app.UI {
	return app.Div().
			...
			app.Div().
				...
				Body(
					app.Div().
						...
						Body(
							app.Div().
								ID("time-picker-16517600167687u527je7xrv").
								Body(
									app.Div().
										...
										Body(
											app.Input().
												Aria("haspopup", "menu").
												ID("time-picker-16517600167687u527je7xrv-input").
